function [bootstrapped_times,trials] = simulate_BAT(all_electrodes, NUM_ELEC,TRIAL_RANGE, NUM_SIMS,BIN,START_TIME, END_TIME,REMOVE)
    ...
    trials = cell(NUM_SIMS,1);
%     bootstrapped_times = zeros(NUM_ELEC,NUM_SIMS,NUM_SIMS);
    ...
    for j = 1:NUM_SIMS
        ...
        %TEMPORARY CODE TO SAVE HIGH R2 TRIALS
%         bootstrapped_times(:,j,j) = BAM;
