...
%Datasets for Big Papi: DATASETS = ['M1TM_20101020'; 'M1TM_20101021'; '20101022'; 'M1TM_20101025'; 'M1TM_20101026'; 'M1TM_20101028'];
% DATASETS = [];
...
for d = 1:size(DATASETS,1)
    ...
    chan2rc = makechan2rc_mac('bp','mio');
